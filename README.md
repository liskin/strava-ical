...
-->
    ...
    Options:
      --csv FILENAME          Load activities from CSV instead of the strava-offline database
                              (columns: distance, elapsed_time, id, moving_time, name, start_date,
                              start_latlng, total_elevation_gain, type)
      ...
      -m, --max-size SIZE     Maximum size of the output file in bytes (accepts K and M suffixes as
                              well)
